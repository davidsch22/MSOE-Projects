...
% deepNetworkDesigner
imdsValOrig = imdsVal;
imdsVal = augmentedImageDatastore([227 227 3], imdsValOrig)
...
lgraph = removeLayers(lgraph,["prob","output"]); % You'll get an error if your layer names are different
...
if false
    ...
    numIterations = 11;
    iterationScheme = linspace(0.88, 0.98, numIterations);
end
