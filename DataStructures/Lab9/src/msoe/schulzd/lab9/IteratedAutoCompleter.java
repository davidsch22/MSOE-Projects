...
/**
 * Class used when searching with the iterator algorithm
 */
public class IteratedAutoCompleter implements AutoCompleter {
     ...
     * @param copiedList A List that has copied the dictionary from the previous strategy
     */
    public IteratedAutoCompleter(List<String> copiedList) {
        startTime = System.nanoTime();
        dictionary = copiedList;
