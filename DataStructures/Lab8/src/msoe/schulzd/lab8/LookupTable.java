...
public class LookupTable<K extends Comparable<? super K>, V> implements Map<K, V> {
    private int size;
    private List<MyEntry<K, V>> table;
     ...
     *                              this map
     *                              (<a href="{@docRoot}/java.base/java/util/Collection.html#
    ...
    public V get(Object key) {
        MyEntry<K, V> newEntry = new MyEntry((K)key, null);
        int index = Collections.binarySearch(table, newEntry);
        if (index < 0) {
            return null;
        } else {
     ...
     * @throws ClassCastException            if the key is of an inappropriate type for
     *                                       this map
     *                                       (<a href="{@docRoot}/java.base/
     *                                       java/util/Collection.html#optional
    ...
    public boolean containsKey(Object key) {
        MyEntry<K, V> newEntry = new MyEntry((K)key, null);
        return Collections.binarySearch(table, newEntry) >= 0;
    }
     ...
     * of calling {@link #put(Comparable, Object)} put(k, v)} on this map once
