...
public class LifeGrid {
    ...
    /**
     * Toggles the selected cell's alive status
     * @param x The x position of the cell
     * @param y The y position of the cell
     */
    public void toggleCell(int x, int y) {
        Cell selectedCell = cells.get(y).get(x);
        selectedCell.setAlive(!selectedCell.isAlive());
        selectedCell.updateColors();
    ...
    public void trackCells() {
        ...
        aliveCells = alive;
        deadCells = (numberOfCellsHigh * numberOfCellsWide) - aliveCells;
    }
